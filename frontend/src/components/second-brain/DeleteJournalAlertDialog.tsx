...
const DeleteJournalAlertDialog = ({cancelRef, onClose, isOpen, action}: Props) => {
  const onActionClick = () => {
    action();
    onClose();
  }
  return (
    <AlertDialog
      ...
      >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>Delete this journal?</AlertDialogHeader>
...
export default DeleteJournalAlertDialog
