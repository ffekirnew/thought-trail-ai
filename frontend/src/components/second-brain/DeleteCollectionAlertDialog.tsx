...
const DeleteCollectionAlertDialog = ({cancelRef, onClose, isOpen, action}: Props) => {
  const onActionClick = () => {
    action();
    onClose();
  }
  return (
    <AlertDialog
      ...
      >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>Delete this collection?</AlertDialogHeader>
          <AlertDialogCloseButton />
          <AlertDialogBody>
            You will not be able to recover this collection after now.
          </AlertDialogBody>
          <AlertDialogFooter>
