...
import { Avatar, Text, Editable, EditableInput, EditablePreview, FormControl, FormLabel, HStack, Spacer, VStack } from "@chakra-ui/react";
  ...
  >
    <form>
      <HStack padding={5} alignItems={'start'}>
        <Avatar src={userAvatar} size={'2xl'} bg={'gray.900'} borderWidth={'1px'} borderColor={'gray.500'} />
        <Spacer />
        <VStack>
      ...
      <VStack align={'left'} height={'100%'} width={'100%'} paddingX={10} gap={5} bg={'gray.700'} paddingY={5}>
        <FormControl>
          <FormLabel>Name</FormLabel>
          <Editable defaultValue={user.name[0].toUpperCase() + user.name.slice(1)}>
