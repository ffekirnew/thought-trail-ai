...
import {
  ...
  GetCollectionDto,
  UpdateCollectionDto,
} from "../../application/features/collections/dtos";
...
import {
  ...
  GetNotes,
  UpdateNoteDto,
} from "../../application/features/collections/dtos/collection-note";
...
class CollectionsController {
  ...
  constructor() {
    ...
    this.collectionsApplication = new CollectionsApplication(
      collectionsRepository,
      slugify,
    );
  }
  ...
  create = async (req: Request, res: Response) => {
    ...
    const response =
      await this.collectionsApplication.create(createCollectionDto);
  ...
  getAll = async (req: Request, res: Response) => {
    ...
    const response =
      await this.collectionsApplication.getAll(getAllCollectionsDto);
  ...
  getBySlug = async (req: Request, res: Response) => {
    ...
    const response =
      await this.collectionsApplication.getBySlug(getCollectionDto);
    if (response.success) res.status(200).send(response);
    else res.status(400).send(response);
  };
  ...
  update = async (req: Request, res: Response) => {
    ...
    const response =
      await this.collectionsApplication.update(updateCollectionDto);
  ...
  delete = async (req: Request, res: Response) => {
    ...
    const response =
      await this.collectionsApplication.delete(deleteCollectionDto);
    if (response.success) res.status(204).send(response);
    else res.status(400).send(response);
  };
  ...
  addNoteToCollection = async (req: Request, res: Response) => {
    ...
    const newNoteDto = new CreateNoteDto(
      userId,
      note.title,
      note.body,
      note.tags,
    );
    const addNoteToCollectionDto = new AddNoteDto(
      userId,
      collectionSlug,
      newNoteDto,
    );

    const response = await this.collectionsApplication.addNoteToCollection(
  ...
  getNotes = async (req: Request, res: Response) => {
    ...
    const response = await this.collectionsApplication.getNotes(
      getCollectionNotesDto,
    );
    if (response.success) res.status(200).send(response);
    else res.status(400).send(response);
  };
  ...
  getNote = async (req: Request, res: Response) => {
    ...
    const response =
      await this.collectionsApplication.getNote(getCollectionNoteDto);
    if (response.success) res.status(200).send(response);
    else res.status(400).send(response);
  };
  ...
  updateNote = async (req: Request, res: Response) => {
    ...
    const response =
      await this.collectionsApplication.updateNoteInCollection(updateNotedto);
    if (response.success) res.status(204).send(response);
    else res.status(400).send(response);
  };
  ...
  deleteNote = async (req: Request, res: Response) => {
    ...
    const response =
      await this.collectionsApplication.deleteNoteFromCollection(deleteNotedto);
    if (response.success) res.status(204).send(response);
    else res.status(400).send(response);
  };
}
